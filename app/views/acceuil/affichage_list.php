  ...
  <div class="sidebar">
    ...
    <div class="logPRO">
      ...
      <ul>
        ...
        <li class="active"><i class="fas fa-graduation-cap"></i> <a href="/promotion" class="<?= ($currentPath == '/promotion') ? 'active' : '' ?>"style="text-decoration: none; color: orange;"; >Promotions</li>
